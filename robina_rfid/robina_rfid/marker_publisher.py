...
import tf2_ros
from tf2_geometry_msgs import PoseStamped as TF2PoseStamped  # Required for tf2
import os
...
class MarkerPublisher(Node):
    ...
    def publish_markers(self):
        ...
        for marker in self.markers:
            ...
            # Try transforming the pose from map to odom (or any other frame)
            try:
                pose = TF2PoseStamped()
                ...
                transformed = self.tf_buffer.transform(pose, 'odom', timeout=rclpy.duration.Duration(seconds=1.0))
                marker.pose = transformed.pose
